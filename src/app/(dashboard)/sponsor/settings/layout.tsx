...
const settingsNavItems = [
  {
    label: "Account",
    href: "/sponsor/settings/account",
    icon: "hugeicons:user-circle",
  },
  {
    label: "Notifications",
    href: "/sponsor/settings/notification",
    icon: "hugeicons:notification-01",
  },
  {
    label: "Password & Security",
    href: "/sponsor/settings/password",
    icon: "hugeicons:lock-key",
  },
  {
    label: "Billing",
    href: "/sponsor/settings/billing",
    icon: "hugeicons:credit-card",
  },
];

export default function SponsorSettingsLayout({
  children,
}: {
  children: ReactNode;
}) {
