		...
		<main className='bg-white'>
			...
			<section className='py-[6rem] max-w-[1300px] mx-auto md:w-[90%] w-[100%] px-[1rem]'>
				...
				<p
					...
					data-aos-delay='100'
				>
					Designed to help you learn smarter and achieve more, iExcelo makes exam
					preparation seamless, engaging, and effective, so you can focus on what
					truly matters: excelling.
				</p>
				<div
					data-aos='fade-up'
					data-aos-duration='700'
